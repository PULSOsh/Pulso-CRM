...
export const PERMISSION_KEYS = [
  ...
  // Fase 3 - Financeiro empresarial (F3-02 a F3-09): módulo separado de
  // finance.* (que é especificamente o recebível ligado a contrato/CRM).
  ...
  "payables.reverse",
  "payables.cancel",
  "financial_recurrences.read",
  "financial_recurrences.manage",
  "bank_imports.manage",
